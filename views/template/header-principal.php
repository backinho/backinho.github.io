					...
					<nav class="navbar navbar-expand-md navbar-light">
						<div class="container">
							<a class="navbar-brand" href="<?php echo RUTA_PRINCIPAL;?>">
								<img src="<?php echo RUTA_PRINCIPAL . 'assets';?>/img/logo.png" width="100px" alt="Logo">
							</a>
							<div class="collapse navbar-collapse mean-menu" id="navbarSupportedContent">
								<ul class="navbar-nav m-auto">
									<li class="nav-item">
										<a href="<?php echo RUTA_PRINCIPAL;?>" class="nav-link active">
											Inicio
										</a>
									</li>
									<li class="nav-item">
										<a href="<?php echo RUTA_PRINCIPAL . 'Itinerario';?>" class="nav-link">
											Itinerario
										</a>
									</li>
									<li class="nav-item">
										<a href="<?php echo RUTA_PRINCIPAL . 'tarifas';?>" class="nav-link">
											Tarifas
										</a>
									</li>
									<li class="nav-item">
									...
									<li class="nav-item">
										<a href="<?php echo RUTA_PRINCIPAL . 'ingresar';?>" class="nav-link">
											Ingresar
										</a>
									</li>
								</ul>
